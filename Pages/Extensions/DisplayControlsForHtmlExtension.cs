...
namespace Abc.Pages.Extensions
{
    ...
    {
        public static IHtmlContent DisplayControlsFor<TClassType, TPropertyTYpre>
            (this IHtmlHelper<TClassType> htmlHelper, Expression <Func<TClassType, TPropertyTYpre>> expression)
        {
        ...
        internal static List<object> htmlStrings<TClassType, TPropertyTYpre>(IHtmlHelper<TClassType> htmlHelper, Expression<Func<TClassType, TPropertyTYpre>> expression)
        {
